...
[![Alt text](images/postgresql/postgresql-5.png)](images/postgresql/postgresql-5.png){:target="_blank"}
...
- [Docker Hub - PostgreSQL image](https://hub.docker.com/_/postgres){:target="_blank"}
