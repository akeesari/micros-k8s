#  Create your second containerized microservice with Node JS

## Introduction

Welcome to the second lab in our Microservices chapter. In this session, we will guide you through the creation of a simple RESTful service using the Node.js `npx express-generator` project template.
...
Think of Docker as a handy tool that makes it super easy to package and deploy your applications. It ensures your app works the same way no matter where it's running. With this knowledge, you're set to use Docker to make your development smoother, collaborate better with others, and deploy your apps seamlessly to different places.
