...
<!-- [![Alt text](images/sqlserver/sqlserver-9.png)](images/sqlserver/sqlserver-9.png){:target="_blank"} -->
...
- [Quickstart: Run SQL Server Linux container images with Docker](https://learn.microsoft.com/en-us/sql/linux/quickstart-install-connect-docker?view=sql-server-ver16&tabs=cli&pivots=cs1-bash){:target="_blank"}
