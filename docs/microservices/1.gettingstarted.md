...
for example, here is the devops git structure:
...
Here is the list of applications that we will be creating to get the feeling of Microservices architecture pattern. Here we purposely selected different technology stack and languages to cover more learning scenarios.
...
for example, here is the folder structure of our Microservices and MicroFrontend Applications.
