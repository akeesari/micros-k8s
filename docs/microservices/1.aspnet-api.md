...
Reference architecture diagram from MSDN - [ASP.NET Core Web API](https://learn.microsoft.com/en-us/aspnet/core/tutorials/first-web-api?view=aspnetcore-7.0&tabs=visual-studio)
...
Please refer to our [Git Cheat-Sheet](https://anjikeesari.com/developertools/cheatsheets/git-cheat-sheet/), which provides a comprehensive list of Git commands and their usage. 

<https://anjikeesari.com/developertools/cheatsheets/git-cheat-sheet>
