...
This sample demonstrates how to create restful service and build container using ASP.NET Core Restful APIs. 
...
!!! Best-Practice
    Use the following pattern for docker container naming conventions 
...
That's it! You've successfully pulled your Docker container from Azure Container Registry. You can now use the Docker command-line interface to manage your container and run them locally or deploy them to other environments.
